        ...
        <div className="space-y-4">
          ...
          <label className="w-full block">
            <input
              ...
              className="hidden"
            />
            <div className="w-full py-3 bg-purple-600/20 hover:bg-purple-600/30 border-2 border-purple-500 text-purple-200 font-mono text-sm font-semibold transition-colors cursor-pointer text-center flex items-center justify-center gap-2">
